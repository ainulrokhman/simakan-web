				...
				<div class="card">
					<div class="card-header">
						<div style="float:left;">
							<h3><i class="fa fa-edit text-primary"></i> Edit Work</h3>
						</div>
						<div style="clear:both;"></div>
					</div>
					<div class="card-body">
					<form action="<?php echo base_url();?>updatework" method="post" enctype='multipart/form-data'>
						<input type="hidden" name="id" required="required" value="<?php echo $work['job_id'];?>">
						<div class="form-group">
							<label>Name</label>
							<input type="text" class="form-control" name="name" required="required" placeholder="Name" value="<?php echo $work['job_name'];?>">
						</div>
						<div class="form-group">
							<label>Description</label>
							<textarea class="form-control" rows="3" name="desc" required="required" placeholder="Description"><?php echo $work['job_description'];?></textarea>
						</div>
						...
						<div class="table-responsive">
							<table class="table table-bordered" id="datatable-basic">
								...
								<tbody>
									<?php
										$no=0;
										foreach($list_work as $data_work){ 
										$no++;
									?>
									<tr>
